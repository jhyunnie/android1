...
public class landmarkRecycle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<List<List<LandMark>>> callRecycle = landmarkAPI.getRecycleLandmarkInfo();
        callRecycle.clone().enqueue(new Callback<List<List<LandMark>>>() {
            @Override
            public void onResponse(Call<List<List<LandMark>>> call, Response<List<List<LandMark>>> response) {
                if (response.isSuccessful()){
                    ...
                    LinearLayoutManager layoutManager = new LinearLayoutManager(landmarkRecycle.this,LinearLayoutManager.VERTICAL,false);
